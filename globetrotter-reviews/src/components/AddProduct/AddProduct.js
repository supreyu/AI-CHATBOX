...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 如果有错误发生，则显示错误消息
      alert(`Product addition failed: ${error.message}`);
  ...
  return (
    <form onSubmit={handleSubmit}>
      <input name="title" value={formData.title} onChange={handleChange} placeholder="product" />
      <input name="author" value={formData.author} onChange={handleChange} placeholder="price" />
